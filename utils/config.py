...
parser.add_argument('-bsz','--batch', help='Batch_size', required=False, type=int, default=1)
...
parser.add_argument('-separate_label','--separate_label', help='', required=False, default=1, type=int)  # Tagging Method

parser.add_argument('-LanguageModel', '--LanguageModel', help='language model before encoder', required=False, default=1, type=int)
parser.add_argument('-lm_last_hidden', '--lm_last_hidden', help='lm last hidden for encoder', required=False, default=0, type=int)
parser.add_argument('-delay_update', '--delay_update', help='delay update parameters', required=False, default=4, type=int)
parser.add_argument('-beta', '--beta', help='balance the language modeling loss', required=False, default=1.0, type=float)


parser.add_argument('-all_domains','--all_domains', help='', required=False, default=0, type=int)
